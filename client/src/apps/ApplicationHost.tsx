...
const Soundboard = lazy(async () => ({ default: (await import('./Soundboard/Soundboard')).Soundboard }));
const Terminal = lazy(async () => ({ default: (await import('./Terminal/Terminal')).Terminal }));
const SoundUpload = lazy(async () => ({ default: (await import('./SoundUpload/SoundUpload')).SoundUpload }));
const Users = lazy(async () => ({ default: (await import('./Users/Users')).Users }));
const AppLauncher = lazy(async () => ({ default: (await import('./AppLauncher/AppLauncher')).AppLauncher }));
const ControlPanelApp = lazy(
  async () => ({ default: (await import('./ControlPanel/ControlPanelApp')).ControlPanelApp }),
);
const SoundSettingsApp = lazy(
  async () => ({ default: (await import('./ControlPanel/SoundSettingsApp')).SoundSettingsApp }),
);
const IntegrationSettingsApp = lazy(
  async () => ({ default: (await import('./ControlPanel/IntegrationSettingsApp')).IntegrationSettingsApp }),
);
    ...
    <Show when={ApplicationServer.isOpen('integration-settings')}>
      <Suspense>
        <IntegrationSettingsApp
          data={ApplicationServer.getInstance('integration-settings')?.payload as
